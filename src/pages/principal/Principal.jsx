...
const Principal = () => {
    ...
    return (
        <div style={{minHeight: "100vh"}} className="relative back flex flex-col">
            <div className="flex flex-col lg:flex-row pt-2 px-6 lg:p-36">
                <Animation duration={0.5}>
                    <div className="flex flex-col lg:w-2/3 xl:w-1/2">
                        ...
                        <button type="button" className="w-1/2 xl:w-full back2 px-4 py-2 rounded text-white font-bold my-6">Ver presentación de la app</button>
                    </div>
                </Animation>
